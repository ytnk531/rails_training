...
RSpec.describe ProfilesController, type: :controller do
  ...
  before(:each) do
    p = { id: 5, name: "taro yamada", emailAddress: "t@example.com", password: "444", password_confirmation: "444" }
    User.create! p
  end
  ...
  describe "DELETE #destroy" do
    ...
    context "other user's profile" do
      before(:each) do
        p = { id: 4, name: "taro yamada", emailAddress: "t@example.com", password: "444", password_confirmation: "444" }
        User.create! p
      end
      it "destroys the requested profile" do
        profile = Profile.create! valid_attributes
